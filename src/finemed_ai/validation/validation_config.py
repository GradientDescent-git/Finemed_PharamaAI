...
DUPLICATE_KEYS = {
    "INVOICE.DAT": ["SOURCE_MONTH", "INVNO"],
    "INVDET.DAT": ["SOURCE_MONTH", "INVNO", "MDCODE", "BATCH"],
    "MEDIMAST.DAT": ["SOURCE_MONTH", "MDCODE"],
    "PURCHASE.DAT": ["SOURCE_MONTH", "PINVNO", "MDCODE", "BAT"],
    "COMPUR.DAT": ["SOURCE_MONTH", "PINVNO"],
    "SUPMAST.DAT": ["SOURCE_MONTH", "SUPNO"],
    "SFILE.DAT": ["SOURCE_MONTH", "SCODE"],
    "TFILE.DAT": ["SOURCE_MONTH", "TCODE"],
}
